...
router.post(
  ...
  async function (req, res, next) {
    ...
    const deliveryReportRequest = req.body.deliverys;
    console.log(deliveryReportRequest);
    ...
    myDoc.on("end", () => {
      ...
      res
        .writeHead(200, {
          ...
          "Content-disposition": `attachment;filename=Deliverylist_${datestamp}.pdf`,
        })
        .end(pdfData);
      // console.log(pdfData)
      //console.log(res)
    ...
    myDoc
      .fillColor("#444444")
      .fontSize(20)
      .text("Delivery Details Report", 110, 57)
      .fontSize(10)
      .text("INFACT SOLUTIONS", 200, 50, { align: "right" })
    ...
    for (const deliveryItem of deliveryReportRequest) {
      table.rows.push([
        deliveryItem.numberofitems,
        deliveryItem.deliverdate,
        deliveryItem.delivercost,
        deliveryItem.phonenumber,
        deliveryItem.useremail,
        deliveryItem.courierservice,
        deliveryItem.receiverdetails,
